...
model_name = 'COGNet'
resume_path = './saved/COGNet/Epoch_17_JA_0.3339_DDI_0.08234.model'
...
def main(args):
    # load data
    data_path = '../data/new_dataset/output/records_final.pkl'
    voc_path = '../data/new_dataset/output/voc_final.pkl'

    # ehr_adj_path = '../data/weighted_ehr_adj_final.pkl'
    ehr_adj_path = '../data/new_dataset/output/ehr_adj_final.pkl'
    ddi_adj_path = '../data/new_dataset/output/ddi_A_final.pkl'
    ddi_mask_path = '../data/new_dataset/output/ddi_mask_H.pkl'
    ...
    if args.Test:
        ...
        for _ in range(10):
            ...
            ddi_rate = ddi_rate_score(cur_smm_record, path='../data/new_dataset/output/ddi_A_final.pkl')
